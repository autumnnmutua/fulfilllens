...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    "order_id": ("订单编号", "订单号", "订单ID", "order no", "order number"),
    "created_at": ("下单时间", "订单创建时间", "创建时间", "下单日期"),
    "promised_delivery_time": ("承诺送达时间", "承诺交付时间", "预计送达时间"),
    "actual_delivery_time": ("实际送达时间", "实际交付时间", "签收时间", "妥投时间"),
    "ordered_quantity": ("订购数量", "下单数量", "订单数量", "需求数量"),
    "delivered_quantity": ("交付数量", "已交付数量", "签收数量", "妥投数量"),
    "quantity_unit": ("数量单位", "单位", "计量单位"),
    "order_status": ("标准订单状态", "订单状态代码"),
    "raw_order_status": ("订单状态", "原始订单状态", "订单状态名称"),
    "warehouse_id": ("仓库编号", "仓库编码", "仓库ID", "仓库"),
    "carrier_id": ("承运商编号", "承运商编码", "承运商ID", "物流公司"),
    "destination_region": ("目的地区", "收货地区", "目的区域", "区域"),
    "sales_channel": ("销售渠道", "订单渠道", "渠道"),
    "event_id": ("事件编号", "仓库事件编号", "仓库事件ID", "作业事件编号"),
    "event_time": ("事件时间", "作业时间", "轨迹时间", "扫描时间"),
    "event_code": ("标准事件代码", "事件代码", "状态代码"),
    "raw_status": ("物流状态", "仓库状态", "原始状态", "轨迹状态", "作业状态"),
    "quantity": ("事件数量", "作业数量", "处理数量", "数量"),
    "source_system": ("来源系统", "源系统", "数据来源"),
    "tracking_event_id": ("轨迹事件编号", "物流事件编号", "轨迹事件ID"),
    "shipment_id": ("运单标识", "运单编号", "运单号", "包裹编号"),
